...
* **Clean Data**
  + fix types: row 125 "Anmated" becomes "Animated, row 148 "Feale" becomes "Female
  + remove row 73 with missing data, as this could skew the results
...
<REPLACE> summary of the contents
